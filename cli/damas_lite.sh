...
show_help_msg() {
  ...
  echo "   create       - <stdin> create node(s) from <stdin> "
  ...
  echo ""
  echo "    create multiple nodes from <stdin>, useful when the JSON content is too long"
  echo "       cat <input-file> | damas create - "
  echo ""

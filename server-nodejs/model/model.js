module.exports= function Model() {
  ...
  var server = new Server(conf.mongoDB.host, conf.mongoDB.port, {auto_reconnect: true});
  ...
  db.open(function(err, db) {
    if(!err) {
      ...
      db.collection(conf.mongoDB.collection, {strict:true}, function(err, collection) {
        if (err) {

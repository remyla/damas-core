...
Visit the [API-Reference](../docs/3-API-Reference.md) for the documentation.

# Additional Python ressources

[damas_socket.py](damas_socket.py) is a module to connect to a damas-core server using Socketio websockets. See [Event-API](../docs/Event-API.md).

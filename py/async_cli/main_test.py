...
empty_key = {}
element_with_auto_generated_id_key = {"key1": "value1"}
elt_with_specified_identifier_key = {"_id": "/project/folder/file", "additional_key": "value"}
two_elements_key = {"_id": ["identifier1", "identifier2"], "key": "keyvalue"}
two_elements_using_an_array_as_id_key = {"_id": ["identifier1", "identifier2"], "key": "keyvalue"}
graph_edge_element_key = {"_id": "/project/folder/file1", "tgt_id": "/project/folder/file2"}
json_elts_keys_list = [
    # empty_key,
...
async def main(loop):
    # await damas.connect(loop)
    # await test_connection()
    # await test_connection( print)
    # await test_connections_many()
    # await test_connections_many(print)
    # await test_create(id0) # test EmptyKeyException
    # await test_create({}) # test EmptyKeyException
    ...
    # await test_update(element_with_auto_generated_id_key)
    # await test_update(element_with_auto_generated_id_key,print)
    ...
    #
    # await test_create_many_element(loop,json_elts_keys_list, 10, print)
